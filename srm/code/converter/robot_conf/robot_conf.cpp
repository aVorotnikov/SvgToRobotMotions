 ...
 */
static void _p1Func(robot_file_t *rConf, const std::vector<double> &params) {
  rConf->p1.first = true;
 ...
 * @param[in] params line param
 */
static void _p2Func(robot_file_t *rConf, const std::vector<double> &params) {
  rConf->p2.first = true;
 ...
 * @param[in] params line param
 */
static void _p3Func(robot_file_t *rConf, const std::vector<double> &params) {
  rConf->p3.first = true;
 ...
 * @param[in] params line param
 */
static void _distFunc(robot_file_t *rConf, const std::vector<double> &params) {
 ...
 * @param[in] params line param
 */
static void _accuFunc(robot_file_t *rConf, const std::vector<double> &params) {
 ...
 * @param[in] params line param
 */
static void _stepFunc(robot_file_t *rConf, const std::vector<double> &params) {
  rConf->pouringStep.first = true;
  rConf->pouringStep.second = params[0];
}

static std::map<const std::string, line_t> s_Lines = {
  {"p1", {_p1Func, 3}},
  {"p2", {_p2Func, 3}},
  {"p3", {_p3Func, 3}},
  {"dist", {_distFunc, 1}},
